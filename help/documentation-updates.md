...
| 2020 年 4 月 9 日 | 使用 Brand Portal 配置 [!DNL Experience Manager Assets] as a [!DNL Cloud Service] | [!DNL Experience Manager Assets] as a [!DNL Cloud Service] 现在支持 Brand Portal。您可以使用 [!DNL Experience Manager Assets] as a [!DNL Cloud Service] Adobe I/O。<br>- [配置 [!DNL Assets] as a [!DNL Cloud Service] 与Brand Portal](https://docs.adobe.com/content/help/zh-Hans/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html)<br>- [将资产发布到Brand Portal](https://docs.adobe.com/content/help/zh-Hans/experience-manager-cloud-service/assets/brand-portal/publish-to-brand-portal.html) |
