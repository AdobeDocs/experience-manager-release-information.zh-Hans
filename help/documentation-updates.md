...
>[!NOTE]
>
>Experience Manager作为Cloud Service每月发布。
>
...
| 2020 年 10 月 29 日 | 核心组件 | 核心组件版本 2.12.0 中引入了新的 POST 表单处理程序；通过上下文感知配置包含自定义 CSS、JavaScript 和元数据标记的功能；以及可简化自定义组件中的数据层集成的 **DataLayerBuilderutility**。该版本与[创作文档](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=en)以及[可在 GitHub 上获取的开发人员详细信息和项目下载](https://github.com/adobe/aem-core-wcm-components)一起提供。 |
| 2020 年 9 月 24 日 | 完成新的 Dynamic Media 配置后发送收件箱通知 | 当新Dynamic Media配置完成其设置时，您会在Experience Manager的收件箱中收到状态通知。 此通知会告知您配置是否成功。如果配置失败，此通知将提供错误代码。请在联系 Adobe 客户关怀部门时提供此错误代码。<br>请参阅[对新的 Dynamic Media 配置进行故障排除](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en)。 |
| 2020 年 9 月 24 日 | 在 Dynamic Media 配置中重置密码。 | 允许在Dynamic Media中首次临时密码和后续密码重置，而不是通过Dynamic Media Classic进行。 请参阅[在Cloud Services中创建新的Dynamic Media配置](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en#configuring-dynamic-media-cloud-services)、步骤6和7，以及[将密码更改为Dynamic Media。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en#change-dm-password) |
| 2020 年 9 月 24 日 | 使用 Dynamic Media 中的“选择性发布”功能 | 您可以在文件夹级别选择向Experience Manager或Dynamic Media发布或取消发布资产，也可以从中发布或取消发布资产。 您可以使用管理发布或快速发布来完成此任务，而不是仅依赖其设置全局应用于Dynamic Media实例中的所有文件夹的Dynamic Media配置。<br>请参阅[使用 Dynamic Media 中的“选择性发布”功能](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/selective-publishing.html?lang=en)。 |
| 2020 年 9 月 11 日 | 单页应用程序 | 单页应用程序 (SPA) 编辑器 JavaScript SDK [现已开源](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/headless/spa/reference-materials.html?lang=en)。 |
| 2020 年 8 月 27 日 | Dynamic Media 中的 CDN 失效功能 | 您现在可以从 Dynamic Media 发送请求，以使 CDN 缓存在几分钟内过期。当您更新资产并希望这些更改立即在您的网站上生效时，此功能非常有用。<br>请参阅[通过 Dynamic Media 使 CDN 缓存失效](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html?lang=en)。 |
| 2020 年 8 月 11 日 | 用于发布页面的打开和关闭时间属性 | 使用[打开和关闭时间属性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/page-properties.html?lang=en#basic)发布页面时，请查看“页面属性”中的“基本”选项卡，您现在可以[预配置自动复制](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=zh-Hans#on-and-off-times-trigger-configuration)。 |
...
| 2020 年 7 月 15 日 | Sling 备忘单 | [Sling备忘单](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/sling-cheatsheet.html?lang=en)已更新为引用[HTL.](https://experienceleague.adobe.com/docs/experience-manager-htl/using/overview.html?lang=en) |
| 2020 年 6 月 24 日 | 内容片段 | [已对文档进行了更新，因为模型现在为标准模型。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/content-fragments/content-fragments.html?lang=en) |
| 2020 年 6 月 19 日 | Experience Manager | Adobe旨在在其代码、文档和体验中使用公平的术语。<br>因此，对此文档集进行了更新。 |
...
| 2020 年 6 月 4 日 | 使用Brand Portal将Experience Manager资产配置为Cloud Service | Adobe I/O 已升级到 Adobe Developer Console，现在具有新品牌标识、用户界面和工作流。我们已根据最新的Adobe开发人员控制台工作流对文档进行了相应更新，该工作流用于[将Experience Manager资产配置为Brand Portal的Cloud Service。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html?lang=en) |
| 2020 年 6 月 1 日 | 富文本编辑器 (RTE) | 以下有关富文本编辑器(RTE)的文章适用于Adobe Experience Manager as aCloud Service:<br>- [配置RTE](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/rich-text-editor.html?lang=en)<br>- [配置每个插件](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/configure-rich-text-editor-plug-ins.html?lang=en)<br>- [配置RTE以创建无障碍页面](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/rte-accessible-content.html?lang=en)<br>- [使用RTE](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/rich-text-editor.html?lang=en)创作内容 |
...
| 2020 年 5 月 19 日 | 辅助功能和 WCAG 2.1 准则 | 有关WCAG 2.1准则的更新：<br>- [Adobe Experience Manager as aCloud Service和Web无障碍准则](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/compliance/accessibility/web-accessibility.html?lang=en)<br>- [ WCAG 2.1](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/compliance/accessibility/quick-guide-wcag.html?lang=en)<br>- [创建无障碍内容(WCAG 2.1](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html?lang=en)) |
| 2020 年 5 月 4 日 | Dynamic Media 中不受支持的图像格式 | 有关Dynamic Media中不支持的栅格图像文件格式的子类型的信息。<br>请参阅 [Dynamic Media 中不受支持的光栅图像格式](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-formats.html?lang=en)。 |
| 2020 年 4 月 20 日 | 内容片段 | 有关Experience Manager资产HTTP API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html?lang=en)中的[内容片段支持，以及[自定义和扩展内容片段](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-customizing.html?lang=en)和[内容片段配置组件以进行渲染的信息。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-configuring-components-rendering.html?lang=en) |
| 2020 年 4 月 9 日 | 使用Brand Portal将Experience Manager资产配置为Cloud Service | Brand Portal现在支持将Experience Manager资产作为Cloud Service。 您可以在Adobe I/O上配置将Experience Manager资产作为Cloud Service的Brand Portal租户：<br>- [将Experience Manager资产配置为使用Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html?lang=en)<br>- [将资产发布到Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/publish-to-brand-portal.html?lang=en)的Cloud Service |
| 2020 年 4 月 9 日 | Adobe Asset Link v2.0 版本 | Adobe资产链接2.0支持与多个Adobe Experience Manager环境一起使用，并支持将Experience Manager作为Cloud Service。 Experience Manager支持希望在使用AAL将资产上传到文件夹后配置自动执行资产处理工作流的营销人员。 <br>请参阅 [Adobe Asset Link](https://helpx.adobe.com/cn/enterprise/using/adobe-asset-link.html)。 |
| 2020 年 3 月 24 日 | 配置 Dynamic Media 云服务 | 在配置Dynamic MediaCloud Service时，现在有一个新选项可用：<br>**选择性发布** — 如果选择该选项，即表示只会为安全预览自动发布资产，并且可以明确将资产发布到Experience Manager，而无需发布到DMS7以在公共域中交付。<br>请参阅[配置 Dynamic Media 云服务](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en)。 |
| 2020 年 3 月 2 日 | Dynamic Media — 智能裁剪 | 在Dynamic Media组件中使用智能裁剪时，现在有一个新的可用选项：<br>**启用宽高比匹配** — 选择此选项，以便让Dynamic Media选择最匹配原始图像宽高比的智能裁剪呈现版本。<br>请参阅[使用智能裁剪时](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html?lang=en)。 |
| 2020 年 2 月 25 日 | 基于角色的权限 | Cloud Manager 预配置了一些具有适当权限的角色。每个角色都具有与每个角色关联的特定权限、预配置的任务或权限。 [基于角色的权](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/what-is-required/role-based-permissions.html?lang=en) 限页面列出了可用的功能以及能够执行该功能的角色。 |
...
| 2020 年 11 月 26 日 | Experience Manager 6.5 Service Pack 7 | [提供了Experience Manager6.5 Service Pack 7](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html#service-pack) 。 |
...
| 2020 年 9 月 3 日 | 使用 Dynamic Media 中的“选择性发布”功能 | 您可以在文件夹级别选择向Experience Manager或Dynamic Media发布或取消发布资产，也可以从中发布或取消发布资产。 您可以使用&#x200B;**[!UICONTROL 管理发布]**&#x200B;或&#x200B;**[!UICONTROL 快速发布]**&#x200B;来完成此任务，而不是仅依赖其设置全局应用于Dynamic Media实例中的所有文件夹的&#x200B;**Dynamic Media配置**。<br>请参阅[使用 Dynamic Media 中的“选择性发布”功能](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/assets/dynamic/selective-publishing.html)。 |
| 2020 年 9 月 3 日 | Experience Manager 6.5 Service Pack 6 | [提供了Experience Manager6.5 Service Pack 6](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/release-notes/service-pack/sp-release-notes.html)  。 |
...
| 2020 年 7 月 15 日 | Sling 备忘单 | [Sling备忘单](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/developing/platform/sling-cheatsheet.html)已更新为引用[HTL.](https://docs.adobe.com/content/help/zh-Hans/experience-manager-htl/using/overview.html) |
| 2020 年 6 月 19 日 | Adobe Experience Manager | Adobe旨在在其代码、文档和体验中使用公平的术语。<br>因此，对此文档集进行了一系列更新，以反映此权益。 |
| 2020 年 6 月 4 日 | 使用Brand Portal配置Experience Manager资产 | Adobe I/O 已升级到 Adobe Developer Console，现在具有新品牌标识、用户界面和工作流。我们已根据最新的“Adobe开发人员控制台”工作流对文档进行了相应更新，该工作流用于使用Brand Portal配置Experience Manager资产：<br>- [使用Brand Portal配置Experience Manager资产](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html)<br>- [将旧版配置升级到Adobe开发人员控制台](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html#upgrade-integration-65) |
| 2020 年 6 月 4 日 | Experience Manager 6.5 Service Pack 5 | [提供了Experience Manager6.5 Service Pack 5](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/service-pack/sp-release-notes.html) 。 |
| 2020 年 5 月 25 日 | 辅助功能和 WCAG 2.1 准则 | 有关WCAG 2.1准则的更新：<br>- [Adobe Experience Manager as aCloud Service和Web无障碍准则](https://docs.adobe.com/content/help/zh-Hans/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html)<br>- [ WCAG 2.1](https://docs.adobe.com/content/help/zh-Hans/experience-manager-cloud-service/onboarding/accessibility/quick-guide-wcag.html)<br>- [创建无障碍内容(WCAG 2.1](https://docs.adobe.com/content/help/zh-Hans/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html)) |
| 2020 年 4 月 13 日 | 资产版本控制 | 更新了有关如何创建、预览和还原到[版本的Experience Manager中资产的内容和视频。](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/assets/managing/managing-assets-touch-ui.html#asset-versioning) |
...
| 2020 年 3 月 5 日 | Experience Manager 6.5 Service Pack 4 | [提供了Experience Manager6.5 Service Pack 4](https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/release-notes/sp-release-notes.html)  。 |
...
| 日期 | 主题 | 所做更改 |
| --- | --- | --- |
| 2020 年 11 月 26 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 3 | [提供了Experience Manager6.4 Service Pack 8累积修补程序包3](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html) 。 |
| 2020 年 9 月 3 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 2 | [提供了Experience Manager6.4 Service Pack 8累积修补程序包2](https://docs.adobe.com/content/help/zh-Hans/experience-manager-64/release-notes/cfp-release-notes.html) 。 |
...
| 2020 年 6 月 19 日 | Adobe Experience Manager | Adobe旨在在其代码、文档和体验中使用公平的术语。<br>因此，对此文档集进行了一系列更新，以反映此权益。 |
| 2020 年 6 月 4 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 1 | [提供了Experience Manager6.4 Service Pack 8累积修补程序包1](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html) 。 |
...
| 2020 年 3 月 5 日 | Experience Manager 6.4 Service Pack 8 | [提供了Experience Manager6.4 Service Pack 8](https://docs.adobe.com/content/help/zh-Hans/experience-manager-64/release-notes/sp-release-notes.html) 。 |
...
| 2020 年 3 月 5 日 | Experience Manager 6.3.3.8 | [提供了适用于Experience Manager6.3的累积修补程序包6.3.3.8](https://helpx.adobe.com/cn/experience-manager/release-notes--aem-6-3-cumulative-fix-pack.html) 。 |
