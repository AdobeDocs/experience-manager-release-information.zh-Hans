...
| 项目 | 描述 |
|-------|------|
| 定义 | <ul> <li> 按计划发行 </li> <li> 支持在发行说明中定义的特定版本的升级路径 </li> </ul> |
...
| 项目 | 描述 |
|-----|-----|
| 定义 | <ul> <li> 按计划发行 </li> <li> 目前，无法回滚 </li> </ul> |
...
| 包含项 | CFP是一个累积修补程序包，其中包含所有组件在指定日期之前所具有的修补程序。 例如，如果客户应用 CFP3，则 CFP3 = CFP1 + CFP2。 |
| 文档 | 发行说明可在文档门户中找到 |
| 发行频率 | 每季度 |
| 可用性和安装 | <ul> <li> 以包形式提供 </li> <li>  可在 Software Distribution 上获取 </li> <li>  取决于发布的最新服务包 </li> <li>  CFP 是独立的。客户无需担心要查找/解决依赖项。CFP应安装在最新发布的Service Pack上。 </li> <li>  CFP 可以作为单个包进行安装，以改善客户体验。  </li> </ul> |
