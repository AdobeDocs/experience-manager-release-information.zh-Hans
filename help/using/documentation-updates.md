...
>
>有关各个发行版本（当前版本和早期版本）的文档，请参阅[发行说明](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current)。
...
| 2020 年 9 月 24 日 | 使用 Dynamic Media 中的“选择性发布”功能 | 您可以选择在文件夹级别向 Experience Manager 或 Dynamic Media 发布资源或从中取消发布资源。您可以用“管理出版物”或“快速发布”来完成此任务。此方法避免仅仅依赖动态媒体配置，它将设置全局应用于动态媒体实例中的所有文件夹。<br>请参阅[使用 Dynamic Media 中的“选择性发布”功能](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/dynamicmedia/selective-publishing)。 |
| 2020 年 9 月 11 日 | 单页面应用程序 | 单页面应用程序 (SPA) 编辑器 JavaScript SDK [现已开源](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/implementing/developing/hybrid/reference-materials)。 |
...
| 2020 年 7 月 15 日 | Sling 备忘单 | 更新了 [`Sling Cheatsheet`](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/implementing/developing/full-stack/sling-cheatsheet)，以引用 [HTL。](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-htl/content/overview) |
