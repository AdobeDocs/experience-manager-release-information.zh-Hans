...
| 2020 年 3 月 24 日 | 配置 Dynamic Media 云服务 | 在配置 Dynamic Media 云服务时有新选项可用：<br>**选择性发布** - 当选择此选项时，即意味着自动发布资源仅供安全预览。可显式地将资源发布到 Experience Manager，而不发布到 DMS7 以供投放在公共域中。<br>请参阅[配置 Dynamic Media 云服务](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/dynamicmedia/config-dm)。 |
...
| 2020 年 4 月 13 日 | 资源处理 | 新增了有关如何使用工作流处理资源的概述。此外，还新增了介绍如何[自动触发资源处理工作流](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/using/assets-workflow)的主题。 |
