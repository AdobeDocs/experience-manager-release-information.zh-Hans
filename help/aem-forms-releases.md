...
<table> 
  <tbody> 
   ...
   <tr> 
    ...
    <td><a href="https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/release-notes/service-pack/sp-release-notes.html">AEM 6.5.9.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td><a href="https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/release-notes/service-pack/sp-release-notes.html">适用于 AEM 6.5.8.0 的 AEM Forms Service Pack 8 Forms 附加组件包</a></td> 
    <td><a href="https://docs.adobe.com/content/help/zh-Hans/experience-manager-65/release-notes/service-pack/sp-release-notes.html">AEM 6.5.8.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td> 
     <ul> 
      ...
      <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/compatpack/adobe-aemfd-compat-pkg-2.0.32.zip">AEM Forms 兼容包</a></li>
   ...
   <tr> 
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">AEM 6.5.6.0</a></td> 
    <td> 
     <ul> 
      ...
      <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/servicepack/fd/adobe-aemfd-win-pkg-6.0.192.zip">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
   ...
   <tr> 
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">适用于 AEM 6.5.5.0 的 AEM Forms Service Pack 5 Forms 附加组件包</a></td> 
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">AEM 6.5.5.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">适用于 AEM 6.5.4.0 的 AEM Forms Service Pack 4 Forms 附加组件包</a></td> 
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">AEM 6.5.4.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">适用于 AEM 6.5.3.0 的 AEM Forms Service Pack 3 Forms 附加组件包</a></td> 
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=zh-Hans">AEM 6.5.3.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td><a href="https://helpx.adobe.com/cn/experience-manager/6-5/release-notes/sp-release-notes.html">AEM 6.5.2.0</a></td> 
    <td> 
     <ul> 
   ...
   <tr> 
    ...
    <td><a href="https://helpx.adobe.com/cn/experience-manager/6-5/release-notes/sp-release-notes.html">适用于 AEM 6.5.1.0 的 AEM Forms Service Pack 1 Forms 附加组件包</a></td> 
    <td><a href="https://helpx.adobe.com/cn/experience-manager/6-5/release-notes/sp-release-notes.html">AEM 6.5.1.0</a></td> 
    <td> 
     <ul> 
      ...
      <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/servicepack/fd/AEM-Forms-6.5.1.0-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
...
`[1]` 联系 [Adobe 支持团队](https://www.adobe.com/cn/account/sign-in.supportportal.html)以获取 Workbench、权限管理 SDK、可移植保护库 (PPL) 以及增强型 PPL 的安装程序。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><a href="https://docs.adobe.com/content/help/zh-Hans/experience-manager-64/release-notes/cfp-release-notes.html">AEM 6.4.8.4</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html">AEM 6.4.5.0</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html">适用于 AEM 6.4.4.0 的 AEM Forms Service Pack 4 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html">AEM 6.4.4.0</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html">适用于 AEM 6.4.3.0 的 AEM Forms Service Pack 3 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html">AEM 6.4.3.0</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html" target="_blank">适用于 AEM 6.4.2.0 的 AEM Forms Service Pack 2 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html" target="_blank">AEM 6.4.2.0</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html" target="_blank">适用于 AEM 6.4.1.0 的 AEM Forms Service Pack 1 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-4/release-notes/sp-release-notes.html" target="_blank">AEM 6.4.1.0</a></td> 
   <td> 
    <ul> 
     ...
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq640/servicepack/fd/AEM-Forms-6.4.1.0-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
  ...
  <tr> 
   ...
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>5.0.86</strong></p> <p>Central Migration Bridge 包：<strong>6.0.18</strong></p> <p>AEM Websphere 全局安全配置包：<strong>1.0.0</strong></p> <p>AEM Forms 兼容包：<strong>1.0.18</strong></p> <p>AEM Forms 应用程序源代码：<strong>4.0.30</strong></p> </td> 
  </tr> 
 </tbody> 
</table>

`[1]` 联系 [Adobe 支持团队](https://www.adobe.com/cn/account/sign-in.supportportal.html)以获取 AEM [!DNL Forms JEE]、AEM [!DNL Forms] 客户端 SDK、[!DNL LiveCycle] 嵌入包、AEM [!DNL Forms Designer]、RMCSDK、PPL 以及增强型 PPL 的安装程序。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.7</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-FORMS-6.3.3.7-AIX.zip">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.6</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.5</a></td> 
   <td> 
    <ul> 
  ...
  <tr> 
   ...
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">适用于 AEM 6.3 累积修补程序包 6.3.3.4 的 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.4</a></td> 
   <td> 
    <ul> 
   ...
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.112</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0036</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2019 年 3 月 14 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">适用于 AEM 6.3 累积修补程序包 6.3.3.3 的 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.3</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.3-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.3-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.3-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.3-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.3-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包<sup> [2]</sup></a><sup> </sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.104</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0035</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2019 年 1 月 15 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">适用于 AEM 6.3 累积修补程序包 6.3.3.2 的 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.2</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.2-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.2-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.2-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.2-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.2-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包<sup> [2]</sup></a><sup> </sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.94</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0034</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 11 月 15 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">适用于 AEM 6.3 累积修补程序包 6.3.3.1 的 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html" target="_blank">AEM 6.3.3.1</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.1-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.1-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.1-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.1-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.3.1-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包</a><sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.90</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0032</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 9 月 12 日</td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3 Service Pack 3 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp3-release-notes.html">AEM 6.3.3.0</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.3.0-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.3.0-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.3.0-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.3.0-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.3.0-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包</a><sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.82</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0028</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 6 月 26 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.2.2 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.2-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.2-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.2-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.2-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.2-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 </a><sup>[2]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包：<strong>4.1.74</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0026</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 5 月 10 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.2.1 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.1-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.1-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.1-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.1-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.2.1-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 </a><sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK [1]<sup><br /></sup></li> 
     <li>AEM Forms Designer<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
     <li>AEM Forms Workbench 修补程序 <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.70</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0025</strong></p> <p>AEM Forms Designer 安装程序：<strong>630.005</strong></p> <p>AEM Forms Workbench 修补程序：<strong>1007-008</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 4 月 5 日</td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp2-release-notes.html" target="_blank">AEM 6.3 Service Pack 2 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp2-release-notes.html" target="_blank">AEM 6.3.2.0</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.2.0-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.2.0-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.2.0-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.2.0-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3.2.0-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包</a><sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [1]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.64</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0022</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 1 月 8 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.1.2 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.2-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.2-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.2-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.2-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.2-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 </a><sup>[2]</sup></li> 
     <li>AEM Forms JEE 安装程序<sup> [1]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[1]</sup></li> 
     <li>AEM Forms 应用程序源 <sup>[1]</sup></li> 
     <li>文档安全_客户端软件开发包</li> 
     <li>文档安全_可移植保护库 <sup>[1]</sup></li> 
     <li>文档安全_增强型可移植保护库 <sup>[1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.50</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0017</strong></p> <p>AEM Forms 应用程序源：<strong>3.1.22</strong></p> <p>文档安全_客户端软件开发包：<strong>1.0.0.20171220.2.334666</strong></p> <p>文档安全_可移植保护库：<strong>1.0.0.20171220.2.334661</strong></p> <p>文档安全_增强型可移植保护库：<strong>1.0.0.20171220.1.334662</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 11 月 29 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.1.1 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.1-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.1-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.1-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3.1.1-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
  ...
  <tr> 
   ...
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp1-release-notes.html">AEM 6.3 Service Pack 1 Forms 附加组件包</a></td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-3/release-notes/sp1-release-notes.html" target="_blank">AEM 6.3 Service Pack 1</a></td> 
   <td> 
    <ul> 
     ...
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3-SP1-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3-SP1-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3-SP1-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-Forms-6.3-SP1-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包</a><sup> [2]</sup></li> 
     <li>AEM Forms JEE 安装程序 <sup>[1]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[1]</sup></li> 
     <li>AEM Forms 应用程序源 <sup>[1]<br /></sup></li> 
     <li>AEM Workbench 修补程序 [1]</li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/servicepack/fd/AEM-FORMS-6.3-SP1-FSI-REF-SITE" target="_blank">AEM Forms FSI 引用站点包</a></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.18</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0008</strong></p> <p>AEM Forms 应用程序源：<strong>3.1.16</strong></p> <p>AEM Workbench 修补程序：<strong>1003-004</strong></p> <p>AEM Forms FSI 引用站点包：<strong>aemfd: cq-we-finance-pkg:3.1.10</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 8 月 8 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.0.2 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP2-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP2-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP2-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP2-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP2-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包</a> <sup>[2]</sup><br /> </li> 
     <li>AEM Forms JEE 安装程序 <sup>[1]</sup><br /> </li> 
     <li>AEM Forms 客户端 SDK <sup>[1]</sup></li> 
     <li>AEM Forms 应用程序源 <sup>[1]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.14</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0003</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 6 月 23 日</td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.3 累积修补程序包 6.3.0.1 的 Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-3-cumulative-fix-pack.md" target="_blank">AEM 6.3 累积修补程序包</a></td> 
   <td> 
    <ul> 
     <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/cumulativefixpack/fd/AEM-FORMS-6.3-CFP1-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
   ...
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>4.1.6</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.3.0-0002</strong></p> <p>AEM Forms 应用程序源：<strong>3.1.14</strong></p> </td> 
  </tr> 
  <tr> 
...
`[1]`
联系 [Adobe 支持团队](https://www.adobe.com/cn/account/sign-in.supportportal.html)以获取 AEM [!DNL Forms] JEE、AEM [!DNL Forms] 客户端 SDK、[!DNL LiveCycle] 嵌入包、AEM [!DNL Forms Designer]、RMCSDK、PPL 以及增强型 PPL 的安装程序。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 20 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md">AEM 6.2 累积修补程序包 20</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP20-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP20-LX">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP20-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP20-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP20-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序 [2]</li> 
     <li>AEM Forms 客户端 SDK [2]</li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.212</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0043</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2019 年 3 月 7 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 19 的 AEM Forms 附加组件包</a></td> 
   <td>AEM 6.2 累积修补程序包 19</td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP19-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP19-LX">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP19-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP19-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP19-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：3.2.202</p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 12 月 11 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 18 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md">AEM 6.2 累积修补程序包 18</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP18-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP18-LX">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP18-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP18-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP18-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.194</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0042</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 10 月 10 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 17 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md">AEM 6.2 累积修补程序包 17</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP17-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP17-LX">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP17-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP17-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP17-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p> </p> <p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.190</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0041</strong></p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 8 月 3 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 16 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 16</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP16-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP16-LX">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP16-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP16-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP16-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包：<strong>3.2.186</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0040</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 6 月 11 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms" target="_blank">适用于 AEM 6.2 累积修补程序包 15 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 15</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP15-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP15-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP15-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP15-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP15-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.178</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0038</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 4 月 10 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms" target="_blank">适用于 AEM 6.2 累积修补程序包 14 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 14</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP14-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP14-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP14-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP14-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP14-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.170</strong></td> 
  </tr> 
  <tr> 
   <td>2018 年 3 月 12 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 13 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 13</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP13-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP13-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP13-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP13-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP13-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.166</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0031</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 2 月 13 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 12.1 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 12.1</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP12-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP12-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP12-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP12-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP12-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup><br /> </li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.158</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0030</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2018 年 1 月 18 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 11 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 11</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP11-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP11-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP11-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP11-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP11-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 <sup>[3]</sup></a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
     <li>AEM Workbench 修补程序 <sup>[2]<br /></sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.146</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0029</strong></p> <p>AEM Workbench 修补程序：<strong>1028-014</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 12 月 8 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 10 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 10</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP10-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP10-LX">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP10-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP10-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP10-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.138</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0028</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 11 月 9 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 9 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 9</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP9-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP9-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP9-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP9-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP9-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.134</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0023</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 10 月 9 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 8 的 AEM Forms 附加组件包</a></td> 
   <td><p><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 8</a></p> </td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP8-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP8-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP8-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP8-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP8-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.128</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0021</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 9 月 12 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#main-pars_header_1881174372" target="_blank">适用于 AEM 6.2 累积修补程序包 7 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 7</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP7-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP7-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包 </a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP7-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP7-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP7-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.124</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0018</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 8 月 11 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#main-pars_header_1881174372" target="_blank">适用于 AEM 6.2 累积修补程序包 6 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 6 </a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP6-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP6-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP6-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP6-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP6-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包 [3]</a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.112</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0017</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 7 月 5 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#main-pars_header_1881174372">适用于 AEM 6.2 累积修补程序包 5 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md">AEM 6.2 累积修补程序包 5</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包</a> <sup>[3]</sup></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP5-JEE-PKG" target="_blank">AEM Forms JEE 包</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup><br /> </li> 
     <li>AEM Forms 客户端 SDK <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.106</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0015</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 6 月 5 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#main-pars_header_1881174372" target="_blank">适用于 AEM 6.2 累积修补程序包 4 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">AEM 6.2 累积修补程序包 4</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP4-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP4-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP4-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP4-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup><br /> </li> 
     <li>AEM Forms Designer 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms 客户端 SDK<sup> [2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包与客户端 SDK：<strong>3.2.102</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0012</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 5 月 9 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md" target="_blank">适用于 AEM 6.2 累积修补程序包 3 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#main-pars_header_1220661420" target="_blank">AEM 6.2 累积修补程序包 3</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP3-AIX" target="_blank">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP3-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP3-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP3-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup><br /> </li> 
     <li>AEM Forms Designer 安装程序 <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包：<strong>3.2.88</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0011</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 4 月 5 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 2 的 AEM Forms 附加组件包</a><br /> <br /> <br /> </td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms" target="_blank">AEM 6.2 累积修补程序包 2</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP2-AIX">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP2-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP2-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP2-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li>AEM Forms JEE 安装程序<sup> [2]</sup></li> 
     <li>AEM Forms 应用程序源<sup> [2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包：<strong>3.2.78</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0010</strong></p> <p>AEM Forms 应用程序源：<strong>2.2.18</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2017 年 3 月 8 日</td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">适用于 AEM 6.2 累积修补程序包 1 的 AEM Forms 附加组件包</a></td> 
   <td><a href="/help/release-notes-aem-6-2-cumulative-fix-pack.md#forms">AEM 6.2 累积修补程序包 1</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP1-AIX">适用于 AIX 的 AEM Forms 附加组件包</a><br /> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP1-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP1-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/cumulativefixpack/fd/AEM-FORMS-6.2-SP1-CFP1-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
     <li>AEM Forms Designer 安装程序 <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p>AEM Forms 附加组件包：<strong>3.2.70</strong></p> <p>AEM Forms JEE 安装程序：<strong>6.2.0-0009</strong></p> </td> 
  </tr> 
  <tr> 
   <td>2016 年 12 月 19 日</td> 
   <td><a href="https://docs.adobe.com/docs/zh-Hans/aem/6-2/release-notes/sp1.html" target="_blank">AEM 6.2 Service Pack 1 Forms 附加组件包</a></td> 
   <td><a href="https://docs.adobe.com/docs/zh-Hans/aem/6-2/release-notes/sp1.html" target="_blank">AEM 6.2 Service Pack 1</a></td> 
   <td> 
    <ul> 
     ...
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/servicepack/fd/AEM-Forms-6.2-SP1-LX" target="_blank">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/servicepack/fd/AEM-Forms-6.2-SP1-WIN" target="_blank">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/servicepack/fd/AEM-Forms-6.2-SP1-SOL" target="_blank">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq620/servicepack/fd/AEM-Forms-6.2-SP1-OSX" target="_blank">适用于 Mac OS X 的 AEM Forms 附加组件包 </a><sup>[3]</sup></li> 
     <li><sup> </sup>AEM Forms JEE 安装程序 <sup>[2]</sup></li> 
    </ul> </td> 
   <td><p> </p> <p>AEM Forms 附加组件包：<strong>3.2.50</strong></p> <p> </p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td>2016 年 6 月 30 日</td> 
   <td><a href="https://helpx.adobe.com/cn/experience-manager/6-2/forms/using/cf1-release-notes.html" target="_blank">AEM 6.2 Forms 累积修补程序 10325</a> <sup>[1]</sup></td> 
   <td><a href="https://docs.adobe.com/docs/zh-Hans/aem/6-2/deploy.html#par_title">AEM 6.2</a></td> 
   <td> 
    <ul> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-AIX-HOTFIX-10325">适用于 AIX 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-LX-HOTFIX-10325">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-WIN-HOTFIX-10325">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-SOL-HOTFIX-10325">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-OSX-HOTFIX-10325">适用于 Mac OS X 的 AEM Forms 附加组件包 </a><sup>[3]</sup><br /> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/hotfix/fd/AEM-FORMS-6.2-FORMS-APP-SRC-PKG-HOTFIX-10325">AEM Forms 应用程序源代码</a></li> 
    </ul> </td> 
   <td><p> </p> <p> </p> <p>AEM Forms 附加组件包：<strong>3.2.4</strong></p> <p> </p> <p> </p> <p> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-LX">适用于 Linux 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-WIN">适用于 Windows 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-SOL">适用于 Solaris 的 AEM Forms 附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-OSX">适用于 Mac OS X 的 AEM Forms 附加组件包</a> <sup>[3]</sup><br /> </li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-CMB">Central Migration Bridge 和“发送到打印机”</a></li> 
     ...
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/AEM-FORMS-6.2-FORMS-APP-SRC-PKG">AEM Forms 应用程序源代码</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/cq-geometrixx-gov-all-pkg">Geometrixx Gov 引用站点附加组件包</a></li> 
     <li><a href="https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/aem62/fd/cq-geometrixx-finance-pkg">Geometrixx Finance 引用站点附加组件包</a></li> 
    </ul> </td> 
   <td><p> </p> <p>AEM Forms 附加组件包：<strong>3.1.22</strong></p> <p>Central Migration Bridge：<strong>20160413</strong></p> <p>通信管理迁移实用程序：<strong>20160413</strong></p> <p>AEM Forms 应用程序源代码：<strong>2.2.26</strong></p> <p> </p> </td> 
  </tr> 
 </tbody> 
</table>

`[1]` 除了 AEM [!DNL Forms] 附加组件包和 AEM [!DNL Forms] 应用程序的源代码之外，还发布了适用于 Microsoft Office 的 AEM [!DNL Forms] 文档安全扩展的更新版本、JEE Core 上的 AEM [!DNL Forms] 的修补程序以及文档安全组件。有关详细信息，请参阅 [AEM 6.2  [!DNL Forms]  累积修补程序 10325 的发行说明](https://helpx.adobe.com/cn/experience-manager/6-2/forms/using/cf1-release-notes.html)。

`[2]` 联系 [Adobe 支持团队](https://www.adobe.com/cn/account/sign-in.supportportal.html)以获取 AEM [!DNL Forms] JEE、AEM [!DNL Forms] 应用程序源或 AEM [!DNL Forms Designer] 安装程序、AEM [!DNL Forms Workbench] 修补程序或者 AEM-fd 客户端 SDK（如果适用于该版本）。

`[3]` 适用于 Mac OS X 的 AEM [!DNL Forms] 附加组件包在生产环境中不受支持，应当仅将其用于演示目的。PDF 生成器功能不适用于 Mac OS X 包。

>[!NOTE]
>
>AEM [!DNL Forms] 会定期发布补丁或快速修补程序，以解决错误并提高软件的可用性和性能。如果您在使用 AEM [!DNL Forms] 时遇到问题，该问题可能已通过补丁或快速修补程序得以解决。有关可用快速修补程序的详细信息，请参阅 [Adobe Experience Manager 6.2 修补程序](https://helpx.adobe.com/cn/experience-manager/kb/aem62-available-hotfixes.html)。

## 切记事项 {#things-to-remember}

* 上面列出的 AEM Forms 附加组件包适用于 OSGi 上的 AEM [!DNL Forms] 和 JEE 上的 AEM [!DNL Forms]。
* 所有 AEM [!DNL Forms] 附加组件包和快速修补程序都是累积的；也就是说，附加组件包和快速修补程序中包含相应版本组件的所有之前的附加组件包和快速修补程序。例如，如果您正在安装快速修补程序 2.4.50，则它已经包含 AEM [!DNL Forms] 附加组件包 2.4.26。

   >[!NOTE]
   >
   >累积附加组件包和快速修补程序意味着，版本号的前两个数字是相同的。

* 应始终安装可用的最新版 Service Pack/Feature Pack 附加组件包。之所以强烈建议您这么做，是因为最新版中包含安全性、性能、稳定性优化，以及自基础版本正式发布以来推出的关键客户修补程序和增强功能。
* 当您安装 Service Pack 或从以前版本的 AEM 升级到新版本时，请始终安装相应的 AEM [!DNL Forms] 附加组件包。例如，如果从 AEM 6.1 [!DNL Forms] 附加组件包版本 2.2.4 升级到 AEM 6.1 Service Pack 1，请在安装 AEM 6.1 Service Pack 1 之后，安装 AEM [!DNL Forms] 附加组件包版本 2.4.50。
