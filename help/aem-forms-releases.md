...
<table>
 <tbody>
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.8 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.8</td>
   <td>
    <ul>
      <br><b>AEM Forms on JEE 补丁安装程序</b></br>
  ...
  <tr>
   <td>2019 年 12 月 12 日</td>
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.7 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.7</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.6 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.6</td>
   <td>
    <ul>
  ...
  <tr>
   <td>2019 年 7 月 3 日</td>
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.5 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.5</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.4 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.4</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.3 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.3</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.2 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.2</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.3.1 的 Forms 附加组件包</td>
   <td>AEM 6.3.3.1</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.2.2 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.2.1 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.1.2 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.1.1 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.0.2 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
  ...
  <tr>
   ...
   <td>适用于 AEM 6.3 累积修补程序包 6.3.0.1 的 Forms 附加组件包</td>
   <td>AEM 6.3 累积修补程序包</td>
   <td>
    <ul>
...
`[3]`**重要信息**：在安装 AEM Forms on JEE 嵌入包之前，请安装 AEM 累积修补程序包 6.3.1.1 并确保 **Apache Sling 身份验证服务**&#x200B;捆绑包的版本为 1.4.0 或更高版本，否则服务器可能会变得无响应且无法恢复。可在 `http://[server]:[port]/system/console/bundles` 上检查该捆绑包的版本。
