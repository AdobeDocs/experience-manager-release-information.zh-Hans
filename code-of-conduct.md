...
为了营造一个开放和友好的环境，参与者和维护者承诺让参与项目和社区成为每个人没有骚扰的体验。 该保证不分年龄、体型、残疾、族裔、性别认同和表达、经验水平、国籍、个人形象、种族、宗教或性认同和性取向。
...
项目维护者有权并有责任删除、编辑或拒绝与本行为准则不符的评论、提交、代码、Wiki编辑和问题。 或者，暂时或永久禁止任何他们认为不适当、威胁、冒犯、有害行为的贡献者。
