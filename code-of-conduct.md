...
为了营造一个开放和友好的环境，参与者和维护者承诺让参与项目和社区成为每个人没有骚扰的体验。 该承诺适用于所有人，无论年龄、体型、残疾、民族、性别认同和性别表现或经验水平如何。 还包括国籍、个人外貌、种族、宗教以及性认同和性取向。
...
项目维护者有权并有责任删除、编辑或拒绝评论、提交、代码、Wiki编辑和问题。 如果不符合本行为准则，将采取这些措施。 或者，暂时或永久禁止任何他们认为不适当、威胁、冒犯、有害行为的贡献者。

## 范围

当个人代表项目或其社区时，本行为准则同时适用于项目空间和公共空间。代表项目或社区的示例包括使用官方项目电子邮件地址或通过官方社交媒体帐户发帖。 它还包括在线上或线下活动中担任指定代表。 项目维护者可进一步定义和解释项目的呈现方式可。
